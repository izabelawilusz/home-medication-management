  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
          ...
          <p  class="text-center h4 fw-bold mb-4 mx-1 mx-md-4 mt-4">Historia operacji</p>
</div>



<!-- Formularz z filtracją do historii operacji -->
...
echo '<p class="h5 py-3"> Historia operacji użytkownika '.$uzytkownicy.' w okresie od: '.$date_from.' do '.$date_to.'</p>' ;

?>

<table class="table table-bordered table-sm text-center" style="background-color: white">
    <thead>
    <tr style="background-color: #C4BDB8"><th>Użytkownik</th><th>Typ operacji</th><th>Nazwa leku</th><th>Ilość</th><th>Data operacji</th></tr>
...
<table class="table table-bordered table-sm text-center" style="background-color: white">
    <thead>
    <tr style="background-color: #C4BDB8"><th>Użytkownik</th><th>Operacja</th><th>Nazwa leku</th><th>Ilość</th><th>Data operacji</th></tr>
