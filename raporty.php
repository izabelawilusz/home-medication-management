...
<div class="row justify-content-center align-items-center">
    <h4 class="card-subtitle mb-5 ">Wybierz typ raportu, który chcesz wygenerować </h4>
    ...
    <div class="btn-group mr-2" role="group" aria-label="First group">
        <a href="raport_koszty.php">
        <button type="submit" class="btn btn-secondary">Raport kosztów</button>
        </a>
  </div>
  <div class="btn-group mr-2" role="group" aria-label="Second group">
        <a href="raport_rozchod.php">
        <button type="submit" class="btn btn-secondary">Raport przychodów/rozchodów</button>
        </a>
</div>
