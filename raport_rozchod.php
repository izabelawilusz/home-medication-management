  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
          ...
          <p  class="text-center h4 fw-bold mb-5 mx-1 mx-md-4 mt-4">Wygeneruj raport przychodów/rozchodów</p>
</div>
...
<table class="table table-bordered table-sm text-center" style="background-color: white">
    <thead>
    <tr style="background-color: #C4BDB8"><th>Nazwa leku</th><th>Operacja</th><th>Ilość</th><th>Data operacji</th></tr>
...
if (mysqli_num_rows($result)>0) {
    ...
    while($row=mysqli_fetch_assoc($result)){
        echo "<tr><td>".$row["typ_operacji"]."</td><td>".$row["Nazwa_leku"]."</td><td>".$row["ilosc"]."</td><td>".$row["data_operacji"]."</td></tr>";
...
echo '<p class="h6 py-3"> W okresie od: '.$date_from.' do '.$date_to.' :';
echo '<p class="h7 "> - przychód wynosił: <b> '.$przychod.' </b> leków</p>' ;
echo '<p class="h7"> - rozchód wynosił: <b>'.$rozchod.' </b>leków </p><br>' ;
echo '<p class="h7 "> - dodano do apteczki:<b> '.$sum1.'</b> leków</p>' ;
echo '<p class="h7 "> - zutylizowano:<b> '.$sum2.' </b>leków</p>' ;
echo '<p class="h7  mb-4"> - zażyto:<b> '.$sum.' </b>leków</p>' ;


// $query="SELECT ilosc FROM `leki` WHERE `id_apteczki`='$id_apt'";
...
//     echo '<p class="h7  mt-5"> Liczba leków znajdujących się w apteczce:<b> '.$sum4.' </b>leków</p>' ;
